...
public class ComputationTemplate {
  ...
  /**
   * The configuration of the environment. All environment specific configuration goes in here.
   */
  public Map<String, Object> configuration = Collections.emptyMap();

  /**
   * Parameters defined here can be given by the ComputationTask as arguments. The parameters are can be used to supply
   * values at runtime to the configuration of this ComputationTemplate.
   */
  public List<FixedValueParameter> parameters = Collections.emptyList();
